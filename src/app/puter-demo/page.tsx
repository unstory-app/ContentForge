...
export default function PuterDemo() {
    ...
    return (
        <div className="min-h-screen bg-white dark:bg-[#09090b] text-zinc-900 dark:text-zinc-50 selection:bg-zinc-900 selection:text-white dark:selection:bg-white dark:selection:text-black">
            ...
            <main className="max-w-7xl mx-auto px-6 py-16">
                <div className="max-w-3xl mb-16">
                    ...
                    <p className="text-lg text-zinc-500 dark:text-zinc-400 leading-relaxed">
                        ...
                        No servers. No API keys. Just pure creation.
                    </p>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {/* AI Service */}
                    <section className="group p-8 border border-zinc-200 dark:border-zinc-800 rounded-2xl hover:border-zinc-400 dark:hover:border-zinc-600 transition-all">
                        <div className="mb-6">
            ...
            <footer className="border-t border-zinc-200 dark:border-zinc-800 px-6 py-12 mt-20">
                <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
                    <span className="text-sm text-zinc-400">© 2026 ContentForge AI. Powered by Puter Cloud.</span>
                    <div className="flex gap-8">
                        <a href="#" className="text-sm text-zinc-400 hover:text-black dark:hover:text-white transition-colors">Documentation</a>
                        <a href="#" className="text-sm text-zinc-400 hover:text-black dark:hover:text-white transition-colors">API Reference</a>
                        <a href="#" className="text-sm text-zinc-400 hover:text-black dark:hover:text-white transition-colors">GitHub</a>
                    </div>
                </div>
            </footer>
        </div>
